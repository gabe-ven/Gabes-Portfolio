...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      // Synchronous event so NavColorController updates nav-over-light
      // before startViewTransition captures the new-state snapshot.
      document.documentElement.dispatchEvent(
        new CustomEvent("nav-theme-change", { detail: { isDark: newTheme } })
      );
    };
